...
const WeddingCard1 = (props: Props) => {
  ...
  return (
    <div
      ...
      className='flex flex-col rounded-t-[140px] -mt-[10px] shadow-2xl p-6 relative overflow-hidden xl:w-[600px]lg:w-[500px] md:w-[500px]' style={{ backgroundColor: '#AFD7F6' }}>
      ...
      <div className='text-center space-y-6'>
        ...
        <p
          ...
          <p>23 พฤศจิกายน 2024</p>

        </p>

        {/* Custom Message */}
        <p
          className='flex flex-col justify-start items-start font-light leading-relaxed text-white z-1 drop-shadow-[0_5px_5px_rgba(0,0,0,0.2)]'
        >
          <span className=' text-white text-[16px] text-left indent-8'>สวัสดีค่ะ ตาลกับพี่เสริฐ มีข่าวดีจะมาแจ้งให้ทุกคนทราบ!
          กว่า 10 ปีที่เราได้รู้จักและเรียนรู้กัน และตอนนี้พวกเรากำลังจะก้าวไปอีกขั้นของชีวิตคู่แล้ว พวกเรายินดีมากๆ ที่จะเชิญเพื่อนๆ พี่ๆ น้องๆ ทุกคนที่รักมาร่วมเป็นส่วนหนึ่งในวันสำคัญนี้ </span><span className='text-white text-[16px] text-left indent-8'>เราจะเป็นงานของเราจัดขึ้นที่บ้านเกิดของตาลเอง ซึ่งเป็นงานเล็กๆ อบอุ่นและเรียบง่าย
